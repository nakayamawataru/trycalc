...
$(document).ready(function () {
    $('#plans').change(function () {
        ...
        if (planValue == '1500') {
            ...
            $('#crawl-time')[0].value = 0;
            $('#crawl-loc')[0].value =0
            $('#additional-value')[0].innerText = 0
        }
    });

    $('.addition').change(function () {
        var timeValue = $('#crawl-time')[0].value * 150
        var locValue = $('#crawl-loc')[0].value * 300
        $('#additional-value')[0].innerText = timeValue + locValue
    });
    ...
    $('.price').change(function () {
        ...
        var timeValue = $('#crawl-time')[0].value * 150
        var locValue = $('#crawl-loc')[0].value * 300
        var additionalValue = timeValue + locValue
        var totalValue = parseInt(planValue) + parseInt(additionalValue)
        $('#total-value')[0].innerText = totalValue
    });
});
/*global $*/
...
function calcuAdditionalPrice(){
    ...
    var additionalPrice = postPrice + replyPrice + reportPrice;
